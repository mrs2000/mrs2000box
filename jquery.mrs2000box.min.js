...
function K(c){var b="";a.showNumber&&c.rel&&(b+="<b>\u0424\u043e\u0442\u043e \u2116"+c.rel+"</b> ");return b+c.title}function t(){h.hide();d.hide();n.unbind("click");p.unbind("click");x.unbind("click");f.unbind("load");f.unbind("click");b(window).unbind("resize",E);b(document).unbind("keyup",F);w=!1}a=b.extend({showTitle:!0,showNumber:!0,showGallery:!1,advanced:!1,onBeforeLoad:null,onLoad:null,onResize:null},a);a.advanced&&(a.showGallery=!0,a.showTitle=!0,a.showNumber=!0);var u=null,h=null,f=null,
d=null,n=null,p=null,x=null,q=null,v=null,c=[],e=0,g=null,A=1,k,l,H,w=!1,r=!0,z;return b(this).each(function(){var d;if("A"==this.tagName){d=b(this).parent();if(d.data("m2b"))return;d.data("m2b",!0)}else d=b(this);d.on("click","a",function(b){b.preventDefault();L();c=[];if(a.showGallery){var f=this;d.find("a").each(function(a,b){b==f&&(e=a);c.push({object:b,href:b.href,title:K(b)})})}else c.push({object:this,href:this.href,title:K(this)});1<c.length&&a.showGallery?(n.show(),p.show()):(n.hide(),p.hide());
y();w=!0})})}})(jQuery);